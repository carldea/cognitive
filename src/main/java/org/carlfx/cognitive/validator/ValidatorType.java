...
public enum ValidatorType {
    /**
     * Global type of validation is not specific to a field in the UI form. e.g. When saving the server indicates there's a duplicate entry.
     */
    GLOBAL,
    /**
     * A field specific validator allows UI to inform a user there is a validation error on a field.
     */
    FIELD
}
